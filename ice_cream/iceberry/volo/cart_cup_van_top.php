              ...
              <div class="card mb-4 shadow-sm">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-9" id="header-text" >"Вологодский пломбир"<br>КАР.СТАКАН_ВП_ПЛОМБИР_60гр.
                    </div>
                  </div>
                </div>
                <img class="card-img-top" data-src="volo_cup_van.png" alt="Thumbnail [100%x225]"
                  ...
                  src="../../assets/icecream_images/volo_cart_cup_van.png" data-holder-rendered="true">
