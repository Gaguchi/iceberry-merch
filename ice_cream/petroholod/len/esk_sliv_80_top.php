              ...
              <div class="card mb-4 shadow-sm">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-9" id="header-text" >"Ленинградское"<br>ЭСК_ЛЕН_СЛИВ_80гр.
                </div>
              </div></div>
                <img class="card-img-top" data-src="leni_esk_van_80.png" alt="Thumbnail [100%x225]"
                  style="object-fit: contain; width: auto; height: 166px; display: block; padding:20px;" src="../../assets/icecream_images/leni_esk_van_80.png"
