              ...
              <div class="card mb-4 shadow-sm">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-9" id="header-text" >"Петрохолод"<br>БРИКЕТ_ПХ_ПЛОМБИР_200гр.
                </div>
              </div></div>
                <img class="card-img-top" data-src="brik_200_van.png" alt="Thumbnail [100%x225]"
                  style="object-fit: contain; width: auto; height: 166px; display: block; padding:20px;" src="../../assets/icecream_images/brik_200_van.png"
